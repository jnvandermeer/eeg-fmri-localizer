...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), mei 29, 2015, at 11:13
...
text_ask_for_version = visual.TextStim(win=win, ori=0, name='text_ask_for_version',
    text=u"What size of Stimuli?\n\n1) Normal Size (100%)\n2) Smaller Size (75%)\n3) Even Smaller (50%)\n4) Smallest Size (25%)\n5) Doesn't fit on screen (125%)\n6) Even worse fit (150%)",    font=u'Arial',
