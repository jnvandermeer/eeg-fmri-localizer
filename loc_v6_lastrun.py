...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), mei 26, 2015, at 20:55
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'E:\\Dropbox\\OnderzoeksPlan\\EnvironmentalEEG\\localizer\\loc_v6.psyexp',
...
# Initialize components for Routine "key_3"
key_3Clock = core.Clock()
...
#------Prepare to start Routine "key_3"-------
t = 0
key_3Clock.reset()  # clock 
frameN = -1
# update component parameters for each repeat
...
# keep track of which components have finished
key_3Components = []
key_3Components.append(text_4)
key_3Components.append(key_resp_4)
for thisComponent in key_3Components:
    if hasattr(thisComponent, 'status'):
        thisComponent.status = NOT_STARTED
...
thisExp.nextEntry()
# the Routine "key_3" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
...
hideCheckerboard(win,vis_contents)
...
endComponents.append(key_resp_6)
